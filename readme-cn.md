...
[![Go](https://github.com/pengcainiao/zero/workflows/Go/badge.svg?branch=master)](https://github.com/pengcainiao/zero/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/pengcainiao/zero)](https://goreportcard.com/report/github.com/pengcainiao/zero)
...
[![Release](https://img.shields.io/github/v/release/zeromicro/go-zero.svg?style=flat-square)](https://github.com/pengcainiao/zero)
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/pengcainiao/zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    # Go 1.15 及之前版本
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/pengcainiao/zero/tools/goctl@latest
    
    # Go 1.16 及以后版本
    GOPROXY=https://goproxy.cn/,direct go install github.com/pengcainiao/zero/tools/goctl@latest
    ```
...
如果贵公司也已使用 go-zero，欢迎在 [登记地址](https://github.com/pengcainiao/zero/issues/602) 登记，仅仅为了推广，不做其它用途。
